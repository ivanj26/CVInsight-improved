...
class EducationRecommendator(RecommendatorPlugin):
    """ Recommendator plugin for education description. """
    ...
    def metadata(self) -> PluginMetadata:
        return PluginMetadata(
            name="education_recommendator",
            version="1.0.0",
            description="Generate recommendation about education experience description from context information",
