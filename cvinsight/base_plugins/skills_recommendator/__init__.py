...
class SkillsRecommendator(RecommendatorPlugin):
    """ Recommendator plugin for skills description in resume. """
    ...
    def metadata(self) -> PluginMetadata:
        return PluginMetadata(
            name="skills_recommendator",
            version="1.0.0",
            description="Generate recommendation about skills experience description from context information",
    ...
    def get_prompt_template(self) -> str:
        ...
        return """
Here are some context for you to generate the output:
- My Current Role: $current_role

Give me at least 10 examples to showcase my skills.
Returns in JSON format in dictionary. The dictionary itself groups similar skills in the array using this structure: {\"[Group of Skills]\": [\"{skill_1}\", \"{skill_2}\"]}.
Example: {\"Research & Analysis\": [\"Data Analysis (Heatmaps)\", \"Usability Testing\"], \"Programming Language\": [\"C++\", \"C#\", \"Java\"]}
"""
